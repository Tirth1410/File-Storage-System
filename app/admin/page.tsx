    ...
    if (isPending) {
        return (
            <div className="flex items-center justify-center min-h-screen bg-neutral-950 text-white">
                <p className="text-xl font-medium animate-pulse">Loading auth session...</p>
            </div>
        );
    }
            ...
            <div className="max-w-6xl mx-auto space-y-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-neutral-800 pb-6">
                    <div>
                        ...
                        <p className="text-neutral-400 mt-1">Manage user profiles, accounts, and application roles.</p>
                    </div>
                    <button
                                    ...
                                    {users.map((user) => (
                                        <tr key={user.id} className="hover:bg-neutral-900/30 transition-colors">
                                            <td className="p-4">
                                                ...
                                                <div className="text-xs text-neutral-500 font-mono mt-0.5">{user.id}</div>
                                            </td>
                                            ...
                                            <td className="p-4">
                                                {user.banned ? (
                                                    <span className="inline-flex items-center text-xs font-semibold px-2.5 py-0.5 rounded-full bg-red-500/10 text-red-400 border border-red-500/20" title={user.banReason || undefined}>
                                                        Banned
                                                    </span>
                                                ) : (
                                            ...
                                            <td className="p-4 text-right space-x-2">
                                                <button
                                                    ...
                                                    disabled={actionLoading !== null || user.id === session.user.id}

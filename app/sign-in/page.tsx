    ...
    return (
        <main className="max-w-md h-screen flex items-center justify-center flex-col mx-auto p-6 space-y-6 text-white">
            <div className="w-full bg-neutral-950 border border-neutral-800 rounded-2xl p-8 shadow-2xl">
                <h1 className="text-3xl font-extrabold tracking-tight text-center mb-2 bg-gradient-to-r from-white to-neutral-400 bg-clip-text text-transparent">Sign In</h1>
                <p className="text-sm text-neutral-400 text-center mb-6">Access your secure file storage dashboard</p>
                ...
                <p className="text-center text-sm text-neutral-500 mt-6">
                    ...
                    <a href="/sign-up" className="text-white hover:underline font-semibold">Sign Up</a>
                </p>
            </div>
        </main>
    );
